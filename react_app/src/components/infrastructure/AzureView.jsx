...
import CreateAzureModal from "./CreateAzureModal";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter only Azure infrastructure
        const azureInfra = infraResponse.data.filter(infra => infra.type === 'azure');
        setInfrastructure(azureInfra);
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search Azure infrastructure..."
            ...
            {infrastructure
              ...
              .map((item) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {item.config.subscription_id}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {item.config.resource_group}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {item.config.region}
                  </td>
